...
from bobacon.filesystem import get_temp_directory_path, create_temp, clear_temp
from bobacon.download import conditional_download
from bobacon.ffmpeg import extract_frames, read_audio_buffer
...
def before_each() -> None:
	...
	bobacon.globals.temp_frame_format = 'jpg'
...
def test_extract_frames_with_trim_start() -> None:
	bobacon.globals.trim_frame_start = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_start_and_trim_end() -> None:
	bobacon.globals.trim_frame_start = 124
	bobacon.globals.trim_frame_end = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_end() -> None:
	bobacon.globals.trim_frame_end = 100
	data_provider =\
	[
		('.assets/examples/target-240p-25fps.mp4', 120),
		('.assets/examples/target-240p-30fps.mp4', 100),
