...
from bobacon.typing import FaceLandmark68, VisionFrame, Mask, Padding, FaceMaskRegion, ModelSet
...
MODELS : ModelSet =\
{
	'face_occluder':
	{
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/face_occluder.onnx',
		'path': resolve_relative_path('../.assets/models/face_occluder.onnx')
	},
	'face_parser':
	{
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/face_parser.onnx',
...
def get_face_occluder() -> Any:
	...
	with thread_lock():
		...
		if FACE_OCCLUDER is None:
			...
			FACE_OCCLUDER = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(bobacon.globals.execution_device_id, bobacon.globals.execution_providers))
...
def get_face_parser() -> Any:
	...
	with thread_lock():
		...
		if FACE_PARSER is None:
			...
			FACE_PARSER = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(bobacon.globals.execution_device_id, bobacon.globals.execution_providers))
	return FACE_PARSER
