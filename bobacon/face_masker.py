...
from bobacon import inference_manager
...
from bobacon.typing import DownloadSet, FaceLandmark68, FaceMaskRegion, InferencePool, Mask, ModelSet, Padding, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'face_occluder':
	{
		'hashes':
		{
			'face_occluder':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/dfl_xseg.hash',
		...
		'sources':
		{
			'face_occluder':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/dfl_xseg.onnx',
	...
	'face_parser':
	{
		'hashes':
		{
			'face_parser':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/bisenet_resnet_34.hash',
		...
		'sources':
		{
			'face_parser':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/bisenet_resnet_34.onnx',
