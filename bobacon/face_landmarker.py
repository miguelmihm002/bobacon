...
from bobacon import inference_manager, state_manager
from bobacon.download import conditional_download_hashes, conditional_download_sources
from bobacon.face_helper import create_rotated_matrix_and_size, estimate_matrix_by_face_landmark_5, transform_points, warp_face_by_translation
from bobacon.filesystem import resolve_relative_path
from bobacon.thread_helper import conditional_thread_semaphore
from bobacon.typing import Angle, BoundingBox, DownloadSet, FaceLandmark5, FaceLandmark68, InferencePool, ModelSet, Prediction, Score, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'2dfan4':
	{
		'hashes':
		{
			'2dfan4':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/2dfan4.hash',
	...
	'peppa_wutz':
	{
		'hashes':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/peppa_wutz.hash',
		...
		'sources':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/peppa_wutz.onnx',
	...
	'fan_68_5':
	{
		'hashes':
		{
			'fan_68_5':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/fan_68_5.hash',
		...
		'sources':
		{
			'fan_68_5':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/fan_68_5.onnx',
