...
from bobacon.typing import Embedding, FaceLandmark5, InferencePool, ModelOptions, ModelSet, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'arcface':
	{
		'hashes':
		{
			'face_recognizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/arcface_w600k_r50.hash',
