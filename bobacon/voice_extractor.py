...
from bobacon.typing import ModelSet, AudioChunk, Audio
...
MODELS : ModelSet =\
{
	'voice_extractor':
	{
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/voice_extractor.onnx',
...
def get_voice_extractor() -> Any:
	...
	with thread_lock():
		...
		if VOICE_EXTRACTOR is None:
			...
			VOICE_EXTRACTOR = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(bobacon.globals.execution_device_id, bobacon.globals.execution_providers))
