...
from bobacon.typing import Audio, AudioChunk, InferencePool, ModelOptions, ModelSet
...
MODEL_SET : ModelSet =\
{
	'kim_vocal_2':
	{
		'hashes':
		{
			'voice_extractor':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/kim_vocal_2.hash',
		...
		'sources':
		{
			'voice_extractor':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/kim_vocal_2.onnx',
