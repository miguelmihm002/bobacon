...
from bobacon.typing import Age, FaceLandmark5, Gender, InferencePool, ModelOptions, ModelSet, Race, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'fairface':
	{
		'hashes':
		{
			'face_classifier':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/fairface.hash',
		...
		'sources':
		{
			'face_classifier':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/fairface.onnx',
