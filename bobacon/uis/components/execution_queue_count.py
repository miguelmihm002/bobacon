...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		value = bobacon.globals.execution_queue_count,
		step = bobacon.choices.execution_queue_count_range[1] - bobacon.choices.execution_queue_count_range[0],
...
def update_execution_queue_count(execution_queue_count : int = 1) -> None:
	bobacon.globals.execution_queue_count = execution_queue_count
