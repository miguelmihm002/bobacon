...
from bobacon.face_helper import create_rotated_matrix_and_size, create_static_anchors, distance_to_bounding_box, distance_to_face_landmark_5, normalize_bounding_box, transform_bounding_box, transform_points
from bobacon.filesystem import resolve_relative_path
from bobacon.thread_helper import thread_semaphore
from bobacon.typing import Angle, BoundingBox, Detection, DownloadSet, FaceLandmark5, InferencePool, ModelSet, Score, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'retinaface':
	{
		'hashes':
		{
			'retinaface':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/retinaface_10g.hash',
	...
	'scrfd':
	{
		'hashes':
		{
			'scrfd':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/scrfd_2.5g.hash',
	...
	'yoloface':
	{
		'hashes':
		{
			'yoloface':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/yoloface_8n.hash',
