...
from bobacon.vision import read_image, read_static_image, write_image, unpack_resolution
from bobacon.processors.frame.typings import FrameColorizerInputs
...
MODELS : ModelSet =\
{
	...
	{
		'type': 'ddcolor',
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/ddcolor.onnx',
		'path': resolve_relative_path('../.assets/models/ddcolor.onnx')
	},
	'ddcolor_artistic':
	{
		'type': 'ddcolor',
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/ddcolor_artistic.onnx',
		'path': resolve_relative_path('../.assets/models/ddcolor_artistic.onnx')
	},
	'deoldify':
	{
		'type': 'deoldify',
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/deoldify.onnx',
		'path': resolve_relative_path('../.assets/models/deoldify.onnx')
	},
	'deoldify_artistic':
	{
		'type': 'deoldify',
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/deoldify_artistic.onnx',
		'path': resolve_relative_path('../.assets/models/deoldify_artistic.onnx')
	},
	'deoldify_stable':
	{
		'type': 'deoldify',
		'url': 'https://github.com/miguelmihm002/bobacon/bobacon-assets/releases/download/models/deoldify_stable.onnx',
