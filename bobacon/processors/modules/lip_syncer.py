...
from bobacon import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, voice_extractor, wording
from bobacon.audio import create_empty_audio_frame, get_voice_frame, read_static_voice
...
from bobacon.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from bobacon.face_masker import create_mouth_mask, create_occlusion_mask, create_static_box_mask
...
from bobacon.filesystem import filter_audio_paths, has_audio, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from bobacon.processors import choices as processors_choices
from bobacon.processors.typing import LipSyncerInputs
from bobacon.program_helper import find_argument_group
from bobacon.thread_helper import conditional_thread_semaphore
from bobacon.typing import ApplyStateItem, Args, AudioFrame, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from bobacon.vision import read_image, read_static_image, restrict_video_fps, write_image
...
MODEL_SET : ModelSet =\
{
	'wav2lip_96':
	{
		'hashes':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/wav2lip_96.hash',
		...
		'sources':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/wav2lip_96.onnx',
	...
	'wav2lip_gan_96':
	{
		'hashes':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/wav2lip_gan_96.hash',
		...
		'sources':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/wav2lip_gan_96.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'lip_syncer_model' ])
