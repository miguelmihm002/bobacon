...
from bobacon.face_analyser import get_many_faces, get_one_face
from bobacon.face_helper import paste_back, warp_face_by_face_landmark_5
from bobacon.face_masker import create_occlusion_mask, create_static_box_mask
...
from bobacon.processors.typing import FaceEnhancerInputs
from bobacon.program_helper import find_argument_group
from bobacon.thread_helper import thread_semaphore
...
MODEL_SET : ModelSet =\
{
	'codeformer':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/codeformer.hash',
	...
	'gfpgan_1.2':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gfpgan_1.2.hash',
	...
	'gfpgan_1.3':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gfpgan_1.3.hash',
	...
	'gfpgan_1.4':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gfpgan_1.4.hash',
	...
	'gpen_bfr_256':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gpen_bfr_256.hash',
	...
	'gpen_bfr_512':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gpen_bfr_512.hash',
	...
	'gpen_bfr_1024':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gpen_bfr_1024.hash',
	...
	'gpen_bfr_2048':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/gpen_bfr_2048.hash',
	...
	'restoreformer_plus_plus':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/restoreformer_plus_plus.hash',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend' ])
