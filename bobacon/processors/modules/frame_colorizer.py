...
from bobacon.processors.typing import FrameColorizerInputs
...
from bobacon.vision import read_image, read_static_image, unpack_resolution, write_image
...
MODEL_SET : ModelSet =\
{
	'ddcolor':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ddcolor.hash',
	...
	'ddcolor_artistic':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ddcolor_artistic.hash',
	...
	'deoldify':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/deoldify.hash',
	...
	'deoldify_artistic':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/deoldify_artistic.hash',
	...
	'deoldify_stable':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/deoldify_stable.hash',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
