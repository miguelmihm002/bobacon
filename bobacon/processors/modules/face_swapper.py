...
import bobacon.jobs.job_manager
import bobacon.jobs.job_store
import bobacon.processors.core as processors
from bobacon import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, wording
from bobacon.common_helper import get_first
from bobacon.download import conditional_download_hashes, conditional_download_sources
from bobacon.execution import has_execution_provider
from bobacon.face_analyser import get_average_face, get_many_faces, get_one_face
from bobacon.face_helper import paste_back, warp_face_by_face_landmark_5
from bobacon.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from bobacon.face_selector import find_similar_faces, sort_and_filter_faces
from bobacon.face_store import get_reference_faces
from bobacon.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from bobacon.inference_manager import get_static_model_initializer
from bobacon.processors import choices as processors_choices
from bobacon.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from bobacon.processors.typing import FaceSwapperInputs
from bobacon.program_helper import find_argument_group, suggest_face_swapper_pixel_boost_choices
from bobacon.thread_helper import conditional_thread_semaphore
from bobacon.typing import ApplyStateItem, Args, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from bobacon.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
MODEL_SET : ModelSet =\
{
	'blendswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/blendswap_256.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/blendswap_256.onnx',
	...
	'ghost_256_unet_1':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_1.hash',
				'path': resolve_relative_path('../.assets/models/ghost_256_unet_1.hash')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/arcface_converter_ghost.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_1.onnx',
				'path': resolve_relative_path('../.assets/models/ghost_256_unet_1.onnx')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/arcface_converter_ghost.onnx',
	...
	'ghost_256_unet_2':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_2.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_2.onnx',
	...
	'ghost_256_unet_3':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_3.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ghost_256_unet_3.onnx',
	...
	'inswapper_128':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/inswapper_128.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/inswapper_128.onnx',
	...
	'inswapper_128_fp16':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/inswapper_128_fp16.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/inswapper_128_fp16.onnx',
	...
	'simswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/simswap_256.hash',
				'path': resolve_relative_path('../.assets/models/simswap_256.hash')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/arcface_converter_simswap.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/simswap_256.onnx',
				'path': resolve_relative_path('../.assets/models/simswap_256.onnx')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/arcface_converter_simswap.onnx',
	...
	'simswap_512_unofficial':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/simswap_512_unofficial.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/simswap_512_unofficial.onnx',
	...
	'uniface_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/uniface_256.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/uniface_256.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost' ])
