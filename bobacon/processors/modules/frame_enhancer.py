...
from bobacon import config, content_analyser, inference_manager, logger, process_manager, state_manager, wording
from bobacon.common_helper import create_int_metavar
from bobacon.download import conditional_download_hashes, conditional_download_sources
from bobacon.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from bobacon.processors import choices as processors_choices
from bobacon.processors.typing import FrameEnhancerInputs
from bobacon.program_helper import find_argument_group
from bobacon.thread_helper import conditional_thread_semaphore
from bobacon.typing import ApplyStateItem, Args, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from bobacon.vision import create_tile_frames, merge_tile_frames, read_image, read_static_image, write_image
...
MODEL_SET : ModelSet =\
{
	'clear_reality_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/clear_reality_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/clear_reality_x4.onnx',
	...
	'lsdir_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/lsdir_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/lsdir_x4.onnx',
	...
	'nomos8k_sc_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/nomos8k_sc_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/nomos8k_sc_x4.onnx',
	...
	'real_esrgan_x2':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x2.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x2.onnx',
	...
	'real_esrgan_x2_fp16':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x2_fp16.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x2_fp16.onnx',
	...
	'real_esrgan_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x4.onnx',
	...
	'real_esrgan_x4_fp16':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x4_fp16.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x4_fp16.onnx',
	...
	'real_esrgan_x8':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x8.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x8.onnx',
	...
	'real_esrgan_x8_fp16':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x8_fp16.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_esrgan_x8_fp16.onnx',
	...
	'real_hatgan_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_hatgan_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/real_hatgan_x4.onnx',
	...
	'span_kendata_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/span_kendata_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/span_kendata_x4.onnx',
	...
	'ultra_sharp_x4':
	{
		'hashes':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ultra_sharp_x4.hash',
		...
		'sources':
		{
			'frame_enhancer':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/ultra_sharp_x4.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'frame_enhancer_model', 'frame_enhancer_blend' ])
