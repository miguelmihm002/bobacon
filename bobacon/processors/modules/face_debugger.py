...
from bobacon import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, wording
from bobacon.face_analyser import get_many_faces, get_one_face
from bobacon.face_helper import warp_face_by_face_landmark_5
...
from bobacon.filesystem import in_directory, same_file_extension
from bobacon.processors import choices as processors_choices
from bobacon.processors.typing import FaceDebuggerInputs
from bobacon.program_helper import find_argument_group
from bobacon.typing import ApplyStateItem, Args, Face, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
