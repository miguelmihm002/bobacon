...
from bobacon.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from bobacon.processors.typing import AgeModifierInputs
from bobacon.program_helper import find_argument_group
from bobacon.thread_helper import thread_semaphore
from bobacon.typing import ApplyStateItem, Args, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'styleganex_age':
	{
		'hashes':
		{
			'age_modifier':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/styleganex_age.hash',
		...
		'sources':
		{
			'age_modifier':
			{
				'url': 'https://github.com/miguelmihm002/bobacon/releases/download/models/styleganex_age.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		bobacon.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
